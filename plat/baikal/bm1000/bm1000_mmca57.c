...
{
	const unsigned int cluster = MPIDR_AFFLVL1_VAL(mpidr);
...
void mmca57_reconf_sclken(const uintptr_t base, const unsigned int div)
{
	...
	mmio_setbits_32(base + MMCA57_SCLKEN, MMCA57_SCLKEN_SET_DIV);
