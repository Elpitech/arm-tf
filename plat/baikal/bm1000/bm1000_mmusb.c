...
void mmusb_init(void)
{
	...
	reg &= ~(MMUSB_GPR_MMRST_NIC_CFG_SLV   |
		 MMUSB_GPR_MMRST_NIC_CFG_MSTR  |
		 MMUSB_GPR_MMRST_NIC_FUNC_SLV  |
		 MMUSB_GPR_MMRST_NIC_FUNC_MSTR |
	...
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_USB2,     NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_USB3,     NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_SATA0,    NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_SATA1,    NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_SMMU,     NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_GIC,      NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMUSB_NIC_CFG_SECURITY_DMACM2MN, NIC_SECURITY_REGION0_NONSECURE);
	...
	mmio_write_32(MMUSB_GPRS_BASE + 0x00,
		      BIT(0)); /* MMUSB_GPR_MMRST */
}
