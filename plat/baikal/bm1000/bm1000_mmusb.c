...
#define MMUSB_GPR(offset)	(MMUSB_GPR_BASE + offset)
...
/* SATA */
#define MMUSB_SATA_PHY_CLK			MMUSB_GPR(0x80)
...
void mmusb_init(void)
{
	...
	cmu_pll_on(MMUSB_CMU0_BASE, &usb_lcru_pll_init);
