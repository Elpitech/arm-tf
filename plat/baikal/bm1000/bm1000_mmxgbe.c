...
void mmxgbe_init(void)
{
	...
	mmio_clrbits_32(MMXGBE_GPR_MMRST,
			MMXGBE_GPR_MMRST_NIC_CFG_SLV  |
			MMXGBE_GPR_MMRST_NIC_CFG_MSTR |
			MMXGBE_GPR_MMRST_NIC_FUNC_SLV |
			MMXGBE_GPR_MMRST_NIC_FUNC_MSTR);
...
void mmxgbe_ns_access(void)
{
	...
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_VDU,	  NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_XGBE0_CTRL, NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_XGBE0_PHY,  NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_XGBE1_CTRL, NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_XGBE1_PHY,  NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_GMAC0,      NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_GMAC1,      NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_SMMU,       NIC_SECURITY_REGION0_NONSECURE);
	mmio_write_32(MMXGBE_NIC_CFG_SECURITY_HDMI,       NIC_SECURITY_REGION0_NONSECURE);

	/* Enable non-secure access to some GPRs */
	mmio_write_32(MMXGBE_GPRS_BASE + 0x00,
		      BIT(0)); /* MMXGBE_GPR_MMRST */
}
