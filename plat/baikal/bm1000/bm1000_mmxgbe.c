...
static const cmu_pll_ctl_vals_t mmxgbe_lcru_pll1_init = { 0, 0x6b, 0xca, 0, 0, 0x2c, 0, 0x2c }; /* 25.25 MHz */
...
void mmxgbe_init(void)
{
	...
	cmu_pll_on(MMXGBE_CMU0_BASE, &mmxgbe_lcru_pll_init);
	...
	cmu_pll_on(MMXGBE_CMU1_BASE, &mmxgbe_lcru_pll1_init);
