...
#define BAIKAL_BOOTFLASH_SPI_BASE	MMAVLSP_SPI_BASE
#define BAIKAL_BOOTFLASH_SPI_BAUDR	16
#define BAIKAL_BOOTFLASH_SPI_SS_LINE	0
#define BAIKAL_BOOTFLASH_CS_GPIO_BASE	MMAVLSP_GPIO32_BASE
#define BAIKAL_BOOTFLASH_CS_GPIO_PIN	24
#define BAIKAL_BOOTFLASH_SUBSECTOR	(4 * 1024)
#define BAIKAL_BOOTFLASH_SIZE		(32 * 1024 * 1024)
...
# define BAIKAL_SPD_TXRX(targetaddr, txbuf, txbufsize, rxbuf, rxbufsize) \
	smbus_txrx(MMAVLSP_SMBUS1_BASE,					 \
		   ...
		   targetaddr, txbuf, txbufsize, rxbuf, rxbufsize)
# if !DEBUG /* This code doesn't fit into debug tf-arm bl1 */
# define BAIKAL_DDRCFG_IN_FLASH
# endif
