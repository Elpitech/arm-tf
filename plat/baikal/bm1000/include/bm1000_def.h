...
#define MAILBOX_SRAM_SIZE			U(0x200000)

#define MAILBOX_SIGNALING_BASE			U(0x200000)
#define MAILBOX_SIGNALING_SIZE			U(0x200000)
...
#define MMPCIE_CMU0_CLKCHCTL_X4_0_MSTR		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(0))
#define MMPCIE_CMU0_CLKCHCTL_X4_0_SLV		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(1))
#define MMPCIE_CMU0_CLKCHCTL_X4_0_CFG		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(2))
#define MMPCIE_CMU0_CLKCHCTL_X4_1_MSTR		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(3))
#define MMPCIE_CMU0_CLKCHCTL_X4_1_SLV		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(4))
#define MMPCIE_CMU0_CLKCHCTL_X4_1_CFG		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(5))
#define MMPCIE_CMU0_CLKCHCTL_X8_MSTR		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(6))
#define MMPCIE_CMU0_CLKCHCTL_X8_SLV		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(7))
#define MMPCIE_CMU0_CLKCHCTL_X8_CFG		(MMPCIE_CMU0_BASE + CMU_CLKCHCTL_OFFSET(8))
...
#define MMPCIE_NIC_CFG_GPV_REGIONSEC_X4_0	(MMPCIE_NIC_CFG_GPV_BASE + 0x0c)
#define MMPCIE_NIC_CFG_GPV_REGIONSEC_X4_1	(MMPCIE_NIC_CFG_GPV_BASE + 0x10)
#define MMPCIE_NIC_CFG_GPV_REGIONSEC_X8		(MMPCIE_NIC_CFG_GPV_BASE + 0x14)
#define MMPCIE_NIC_CFG_GPV_REGIONSEC_SMMU	(MMPCIE_NIC_CFG_GPV_BASE + 0x18)
#define MMPCIE_NIC_GPV_BASE			U(0x40000000)
#define MMPCIE_NIC_GPV_REGIONSEC_X4_0		(MMPCIE_NIC_GPV_BASE + 0x08)
#define MMPCIE_NIC_GPV_REGIONSEC_X4_1		(MMPCIE_NIC_GPV_BASE + 0x0c)
#define MMPCIE_NIC_GPV_REGIONSEC_X8		(MMPCIE_NIC_GPV_BASE + 0x10)
...
#define MMVDEC_GPR(offset)			(MMVDEC_GPR_BASE + offset)
