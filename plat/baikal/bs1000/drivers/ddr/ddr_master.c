...
#ifdef BAIKAL_DDRCFG_IN_FLASH
	if (ddr_port_config->flsh_1t2t &&
	    ddr_port_config->ddr_sign == BAIKAL_FLASH_USE_STR) {
		data->timing_2t = 1; /* enable 2T mode */
	}
#endif
...
#ifdef BAIKAL_DDRCFG_IN_FLASH
	if ((ddr_port_config->flsh_cl) &&
	    (ddr_port_config->ddr_sign == BAIKAL_FLASH_USE_STR)) {
		data->CL = ddr_port_config->flsh_cl;
	}
#endif
...
#ifdef BAIKAL_DDRCFG_IN_FLASH
	if ((ddr_port_config->flsh_tras) &&
	    (ddr_port_config->ddr_sign == BAIKAL_FLASH_USE_STR)) {
		data->tRAS = ddr_port_config->flsh_tras;
	}
#endif
...
#ifdef BAIKAL_DDRCFG_IN_FLASH
	if ((ddr_port_config->flsh_trp) &&
	    (ddr_port_config->ddr_sign == BAIKAL_FLASH_USE_STR)) {
		data->tRP = ddr_port_config->flsh_trp;
	}
#endif
...
#ifdef BAIKAL_DDRCFG_IN_FLASH
	if ((ddr_port_config->flsh_trcd) &&
	    (ddr_port_config->ddr_sign == BAIKAL_FLASH_USE_STR)) {
		data->tRCD = ddr_port_config->flsh_trcd;
	}
#endif
...
#ifdef BAIKAL_DDRCFG_IN_FLASH
	if ((ddr_port_config->flsh_tfaw) &&
	    (ddr_port_config->ddr_sign == BAIKAL_FLASH_USE_STR)) {
		data->tFAW = ddr_port_config->flsh_tfaw;
	}
#endif
