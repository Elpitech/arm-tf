...
#define MAX_XLAT_TABLES			(15 + ((PLATFORM_CHIP_COUNT - 1) * 9))
#else
...
#define SCP_SERVICE_SIZE		0x10
#define SCP_SERVICE_SIZE_ALIGNED	round_up(SCP_SERVICE_SIZE, PAGE_SIZE)
#define BL1_XLAT_BASE			SEC_DRAM_BASE
#define BL1_XLAT_SIZE			0x18000
#define BL2_BASE			(BAIKAL_SEC_DTB_BASE + BAIKAL_DTB_MAX_SIZE)
...
#define BAIKAL_DTB_MAX_SIZE		(512 * 1024)
...
#define BAIKAL_SPI_DDRFW_NVBASE		0x20000
#define BAIKAL_SPI_FIP_NVBASE		0x40000
#define BAIKAL_SPI_FIP_MAX_SIZE		(2 * 1024 * 1024)
#define BAIKAL_DDRCFG_NVBASE		0x280000
