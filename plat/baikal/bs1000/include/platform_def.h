...
#define SEC_DRAM_SIZE			0x10000000
...
#define PLAT_SEC_FIP_BASE		(SEC_DRAM_BASE + BL1_XLAT_SIZE + PLAT_BAIKAL_DTB_MAX_SIZE)
#define PLAT_SEC_FIP_MAX_SIZE		0x600000
#define PLAT_SEC_FIP_LIMIT		(PLAT_SEC_FIP_BASE + PLAT_SEC_FIP_MAX_SIZE)

#define PLAT_BAIKAL_SEC_DTB_BASE	(SEC_DRAM_BASE + BL1_XLAT_SIZE)
#define PLAT_BAIKAL_DTB_MAX_SIZE	0x10000
#define PLAT_BAIKAL_NS_DTB_BASE		NS_DRAM0_BASE
