...
static bl_mem_params_node_t bl2_mem_params_descs[] = {
	...
	{ .image_id = HW_CONFIG_ID,
	  ...
	  .image_info.image_base = BAIKAL_SEC_DTB_BASE,
	  .image_info.image_max_size = BAIKAL_DTB_MAX_SIZE,
	...
	{ .image_id = BL31_IMAGE_ID,
	  ...
	  .ep_info.spsr = SPSR_64(MODE_EL3, MODE_SP_ELX,
				  DISABLE_ALL_EXCEPTIONS),
# if DEBUG
	  .ep_info.args.arg1 = BAIKAL_BL31_PLAT_PARAM_VAL,
# endif
	  SET_STATIC_PARAM_HEAD(image_info, PARAM_EP, VERSION_2, image_info_t,
				IMAGE_ATTRIB_PLAT_SETUP),
	  .image_info.image_base = BL31_BASE,
	  .image_info.image_max_size = BL31_LIMIT - BL31_BASE,
# ifdef BAIKAL_LOAD_BL32
...
# ifdef BAIKAL_LOAD_BL32
	...
	{ .image_id = BL32_EXTRA2_IMAGE_ID,
	   ...
	   SET_STATIC_PARAM_HEAD(image_info, PARAM_EP, VERSION_2,
				 image_info_t, IMAGE_ATTRIB_SKIP_LOADING),
#ifdef SPD_opteed
	   .image_info.image_base = BAIKAL_OPTEE_PAGEABLE_LOAD_BASE,
	   .image_info.image_max_size = BAIKAL_OPTEE_PAGEABLE_LOAD_SIZE,
#endif
	   .next_handoff_image_id = INVALID_IMAGE_ID,
	},
# endif /* BAIKAL_LOAD_BL32 */
...
# else /* PRELOADED_BL33_BASE */
	  .ep_info.pc = BAIKAL_NS_IMAGE_OFFSET,
