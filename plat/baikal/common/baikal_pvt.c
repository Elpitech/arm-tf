/*
 * Copyright (c) 2019-2022, Baikal Electronics, JSC. All rights reserved.
 *
...
#if defined(MMCA57_0_PVT_BASE)
	/* Linux legacy PVT driver uses "pvt_id" for base index encoding */
	if (base < ARRAY_SIZE(pvt_bases)) {
		return pvt_bases[base] + offset;
	}
#endif
