...
#define BAIKAL_SMC_RST_SET		0xc2000700
#define BAIKAL_SMC_RST_CLR		0xc2000701
#define BAIKAL_SMC_PM			0xc2000800

int64_t baikal_smc_flash_handler(uint32_t smc,
				 uint64_t x1,
				 uint64_t x2,
				 uint64_t x3,
				 uint64_t x4,
...
int64_t baikal_smc_clk_handler(uint32_t smc,
			       uint64_t x1,
			       uint64_t x2,
			       uint64_t x3,
			       uint64_t x4);

int64_t baikal_smc_gmac_handler(uint32_t smc,
				uint64_t x1,
				uint64_t x2,
				uint64_t x3,
				uint64_t x4);

int64_t baikal_smc_rst_handler(uint32_t smc,
			       uint64_t x1,
			       uint64_t x2);
